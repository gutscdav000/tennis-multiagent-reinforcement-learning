...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed):
        ...
        # Actor Network (w/ Target Network)
        self.actor_local = Actor(state_size, action_size).to(device)#, random_seed).to(device)
        self.actor_target = Actor(state_size, action_size).to(device)#, random_seed).to(device)
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=LR_ACTOR)
